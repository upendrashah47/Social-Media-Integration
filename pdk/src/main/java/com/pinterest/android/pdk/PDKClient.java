...
//    }
    ...
    public void createPin(String note, String boardId, String image, String link, PDKCallback callback, String imageType) {
...
//            paramList.add(new BasicNameValuePair("state", "768uyFys"));
//
...
//
////            String url = Utils.getUrlWithQueryParams(PROD_WEB_OAUTH_URL, paramList);
////            Intent oauthIntent = new Intent(c, WebViewActivity.class);
////            System.out.println("WEb Login " + url);
////            oauthIntent.putExtra("url", url);
////            ((Activity) c).startActivityForResult(oauthIntent, PDKCLIENT_REQUEST_CODE);
//        } catch (Exception e) {
...
//    }
    ...
    PinterestDialog.PinterestDialogListener mPinterestDialogListener = new PinterestDialog.PinterestDialogListener() {
        @Override
